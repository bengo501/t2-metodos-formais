// Dafny program Pilha.dfy compiled into C#
...
// Command-line arguments: run Pilha.dfy --solver-path C:\Users\bengo\z3-4.12.1\z3-4.12.1-x64-win\bin\z3.exe
// Pilha.dfy
...
class Pilha {
    ...
    ensures dados.Length > old(dados.Length)
  {
    ...
    while i < tamPilha
      ...
      invariant forall k: int {:trigger dados[k]} {:trigger novo[k]} :: 0 <= k < i ==> novo[k] == dados[k]
    ...
    assert dados[..tamPilha] == s;
    assert novo[..tamPilha] == s;
    dados := novo;
    Repr := {this, dados};
  }
  ...
  method inverter()
    ...
    ensures Valid() && fresh(Repr - old(Repr))
    ensures |elementos| == |old(elementos)|
    ensures forall k: int {:trigger elementos[k]} :: 0 <= k < |elementos| ==> elementos[k] == old(elementos)[|old(elementos)| - 1 - k]
  {
    ghost var s := elementos;
    var i := 0;
    var j := tamPilha - 1;
    while i < j
      ...
      invariant forall k: int {:trigger dados[k]} :: 0 <= k < i ==> dados[k] == s[tamPilha - 1 - k]
      invariant forall k: int {:trigger dados[k]} :: j < k < tamPilha ==> dados[k] == s[tamPilha - 1 - k]
      invariant forall k: int {:trigger s[k]} {:trigger dados[k]} :: i <= k <= j ==> dados[k] == s[k]
      decreases j - i
      modifies dados
    {
  ...
  method empilharSobre(outra: Pilha)
    ...
    requires outra != this
    requires Repr !! outra.Repr
    modifies Repr
    ensures Valid() && fresh(Repr - old(Repr))
    ensures elementos == old(elementos) + outra.elementos
    ensures unchanged(outra)
    ensures outra.Valid()
    decreases outra
  {
    ghost var s1 := elementos;
    ghost var s2 := outra.elementos;
    ...
    while k < tamPilha
      ...
      invariant forall t: int {:trigger dados[t]} {:trigger novo[t]} :: 0 <= t < k ==> novo[t] == dados[t]
    ...
    while m < outra.tamPilha
      ...
      invariant novo.Length == total
      invariant forall t: int {:trigger dados[t]} {:trigger novo[t]} :: 0 <= t < tamPilha ==> novo[t] == dados[t]
      invariant forall t: int {:trigger outra.dados[t]} :: 0 <= t < m ==> novo[tamPilha + t] == outra.dados[t]
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      Pilha _0_p;
      Pilha _nw0 = new Pilha();
      _nw0.__ctor();
      _0_p = _nw0;
      (_0_p).empilhar(new BigInteger(10));
      (_0_p).empilhar(new BigInteger(20));
      (_0_p).empilhar(new BigInteger(30));
      BigInteger _1_x;
      BigInteger _out0;
      _out0 = (_0_p).desempilhar();
      _1_x = _out0;
      BigInteger _2_t;
      _2_t = (_0_p).topo();
      (_0_p).empilhar(new BigInteger(40));
      (_0_p).inverter();
      Pilha _3_q;
      Pilha _nw1 = new Pilha();
      _nw1.__ctor();
      _3_q = _nw1;
      (_3_q).empilhar(BigInteger.One);
      (_3_q).empilhar(new BigInteger(2));
      (_0_p).empilharSobre(_3_q);
      BigInteger _4_a1;
      BigInteger _out1;
      _out1 = (_0_p).desempilhar();
      _4_a1 = _out1;
      BigInteger _5_a2;
      BigInteger _out2;
      _out2 = (_0_p).desempilhar();
      _5_a2 = _out2;
      BigInteger _6_a3;
      BigInteger _out3;
      _out3 = (_0_p).desempilhar();
      _6_a3 = _out3;
      BigInteger _7_a4;
      BigInteger _out4;
      _out4 = (_0_p).desempilhar();
      _7_a4 = _out4;
      BigInteger _8_a5;
      BigInteger _out5;
      _out5 = (_0_p).desempilhar();
      _8_a5 = _out5;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Pilha: todas as assercoes foram verificadas estaticamente com sucesso.\n")).ToVerbatimString(false));
    }
  }

  public partial class Pilha {
    public Pilha() {
      this.dados = new BigInteger[0];
      this.tamPilha = BigInteger.Zero;
    }
    public BigInteger[] dados {get; set;}
    public BigInteger tamPilha {get; set;}
    public void __ctor()
    {
      BigInteger[] _nw0 = new BigInteger[Dafny.Helpers.ToIntChecked(BigInteger.Zero, "array size exceeds memory limit")];
      (this).dados = _nw0;
      (this).tamPilha = BigInteger.Zero;
    }
    public bool vazia() {
      return (this.tamPilha).Sign == 0;
    }
    public BigInteger tamanho() {
      return this.tamPilha;
    }
    public BigInteger topo() {
      return (this.dados)[(int)((this.tamPilha) - (BigInteger.One))];
    }
    public void aumentarCapacidade()
    {
      BigInteger _0_novaCap;
      if ((new BigInteger((this.dados).Length)).Sign == 0) {
        _0_novaCap = BigInteger.One;
      } else {
        _0_novaCap = (new BigInteger(2)) * (new BigInteger((this.dados).Length));
      }
      BigInteger[] _1_novo;
      BigInteger[] _nw0 = new BigInteger[Dafny.Helpers.ToIntChecked(_0_novaCap, "array size exceeds memory limit")];
      _1_novo = _nw0;
      BigInteger _2_i;
      _2_i = BigInteger.Zero;
      while ((_2_i) < (this.tamPilha)) {
        (_1_novo)[(int)((_2_i))] = (this.dados)[(int)(_2_i)];
        _2_i = (_2_i) + (BigInteger.One);
      }
      (this).dados = _1_novo;
    }
    public void empilhar(BigInteger x)
    {
      if ((this.tamPilha) == (new BigInteger((this.dados).Length))) {
        (this).aumentarCapacidade();
      }
      BigInteger[] _arr0 = this.dados;
      BigInteger _index0 = this.tamPilha;
      _arr0[(int)(_index0)] = x;
      (this).tamPilha = (this.tamPilha) + (BigInteger.One);
    }
    public BigInteger desempilhar()
    {
      BigInteger x = BigInteger.Zero;
      x = (this.dados)[(int)((this.tamPilha) - (BigInteger.One))];
      (this).tamPilha = (this.tamPilha) - (BigInteger.One);
      return x;
    }
    public void inverter()
    {
      ...
      BigInteger _1_j;
      _1_j = (this.tamPilha) - (BigInteger.One);
      while ((_0_i) < (_1_j)) {
        BigInteger[] _arr0 = this.dados;
        BigInteger[] _arr1 = this.dados;
        BigInteger _rhs0 = (this.dados)[(int)(_1_j)];
        BigInteger _rhs1 = (this.dados)[(int)(_0_i)];
        BigInteger[] _lhs0 = this.dados;
        BigInteger _lhs1 = _0_i;
        BigInteger[] _lhs2 = this.dados;
        BigInteger _lhs3 = _1_j;
    ...
    public void empilharSobre(Pilha outra)
    {
      BigInteger _0_total;
      _0_total = (this.tamPilha) + (outra.tamPilha);
      BigInteger[] _1_novo;
      BigInteger[] _nw0 = new BigInteger[Dafny.Helpers.ToIntChecked(_0_total, "array size exceeds memory limit")];
      _1_novo = _nw0;
      BigInteger _2_k;
      _2_k = BigInteger.Zero;
      while ((_2_k) < (this.tamPilha)) {
        (_1_novo)[(int)((_2_k))] = (this.dados)[(int)(_2_k)];
        _2_k = (_2_k) + (BigInteger.One);
      }
      BigInteger _3_m;
      _3_m = BigInteger.Zero;
      while ((_3_m) < (outra.tamPilha)) {
        BigInteger _index0 = (this.tamPilha) + (_3_m);
        (_1_novo)[(int)(_index0)] = (outra.dados)[(int)(_3_m)];
        _3_m = (_3_m) + (BigInteger.One);
      }
      (this).dados = _1_novo;
      (this).tamPilha = _0_total;
    }
  }
